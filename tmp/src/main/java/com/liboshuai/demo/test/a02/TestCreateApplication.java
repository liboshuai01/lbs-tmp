package com.liboshuai.demo.test.a02;
...
public class TestCreateApplication {
    private static final Logger log = LoggerFactory.getLogger(TestCreateApplication.class);
...
//        testAnnotationConfigApplicationContext();
    ...
    private static void testFileSystemXmlApplication() {
        FileSystemXmlApplicationContext context = new FileSystemXmlApplicationContext("tmp\\src\\main\\resources\\b01.xml");
        for (String name : context.getBeanDefinitionNames()) {
            System.out.println(name);
        }
        System.out.println(context.getBean(Bean2.class).getBean1());
