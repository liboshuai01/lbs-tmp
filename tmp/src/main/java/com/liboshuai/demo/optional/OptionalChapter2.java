...
public class OptionalChapter2 {
    public static void main(String[] args) {
        ...
        System.out.println("emptyOptional: " + emptyOptional); // Optional.empty
        System.out.println("emptyOptional 是否存在值? " + emptyOptional.isPresent()); // false

        System.out.println("\n--- 2. Optional.of(value) ---");
        // 2. Optional.of(value): 创建一个"确定存在的" Optional
        // value 必须是非 null 的
        String name = "Flink 1.18";
        Optional<String> nameOptional = Optional.of(name);
        System.out.println("nameOptional: " + nameOptional); // Optional[Flink 1.18]
        ...
        System.out.println("jobOptional (非 null 值): " + jobOptional); // Optional[DataStream Job]
        ...
        System.out.println("configOptional (null 值): " + configOptional); // Optional.empty
