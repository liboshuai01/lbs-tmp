...
public class OptionalChapter3 {
    public static void main(String[] args) {
        ...
        presentOptional.ifPresent(value -> {
            // 这段代码会被执行
            System.out.println("  -> 值存在, 值为: " + value.toUpperCase()); // FLINK 1.18
        });
        ...
        if (presentOptional.isPresent()) {
            ...
            System.out.println("presentOptional.get(): " + value); // Flink 1.18
        }
        ...
        try {
            ...
            System.out.println("  -> 捕获到异常: " + e.getClass().getName()); // java.util.NoSuchElementException
        }
        ...
        System.out.println("反模式写法: " + greeting); // Hello, Flink 1.18
    }
}
